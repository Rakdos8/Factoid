...
public class Factions implements IFactions {
	 ...
	 */
	@Override
	public Faction createFaction(final String factionName) {
	 ...
	 * @return the faction
	 */
	public Faction createFaction(final String factionName, UUID uuid) {
	 ...
	 */
	@Override
	public boolean removeFaction(final IFaction faction) {
	 ...
	 */
	@Override
	public boolean removeFaction(final String factionName) {
	 ...
	 */
	@Override
	public Faction getPlayerFaction(final IPlayerContainerPlayer player) {

		for (final IFaction faction : factionList.values()) {
