...
public class CommandInfo extends CommandExec {
	 ...
	 */
	public CommandInfo(final CommandEntities entity) throws FactoidCommandException {

		super(entity);
		player = entity.player;
		final Location playerloc = entity.player.getLocation();
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public CommandInfo(final Player player, final ICuboidArea area) throws FactoidCommandException {
