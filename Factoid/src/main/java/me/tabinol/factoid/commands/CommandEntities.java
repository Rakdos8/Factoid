...
public class CommandEntities {
	 ...
	 */
	public CommandEntities(final MainCommand mainCommand, final InfoCommand infoCommand,
			final CommandSender sender, final ArgList argList, final OnCommand onCommand) {
