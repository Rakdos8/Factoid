...
public class CommandCancel extends CommandExec {
	 ...
	 */
	public CommandCancel(final CommandEntities entity) throws FactoidCommandException {
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public CommandCancel(final PlayerConfEntry entry, final boolean fromAutoCancel) throws FactoidCommandException {
