...
public class CommandBan extends CommandThreadExec {
	 ...
	 */
	public CommandBan(final CommandEntities entity) throws FactoidCommandException {
	 ...
	 */
	@Override
	public synchronized void commandThreadExecute(final PlayerCacheEntry[] playerCacheEntry)
