...
public class CommandArea extends CommandExec {
	 ...
	 */
	public CommandArea(final CommandEntities entity) throws FactoidCommandException {
	...
	public void commandExecute() throws FactoidCommandException {
		...
		if (curArg.equalsIgnoreCase("add")) {
			...
			final double price = entity.playerConf.getSelection().getAreaAddPrice();
			...
			final ICuboidArea areaToReplace = entity.playerConf.getSelection().getAreaToReplace();
