...
public class CommandSetspawn extends CommandExec {
	 ...
	 */
	public CommandSetspawn(final CommandEntities entity) throws FactoidCommandException {
	...
	public void commandExecute() throws FactoidCommandException {
		...
		final String posStr = StringChanges.locationToString(loc);

		// Set flag
		final LandFlag flag = new LandFlag(FlagList.SPAWN.getFlagType(), posStr, true);
