...
public class ArgList {
	 ...
	 */
	public ArgList(final String[] arg, final CommandSender player) {
	 ...
	 */
	public void setPos(final int iterator) {
	 ...
	 */
	public FlagType getFlagTypeFromArg(final boolean isAdminmod, final boolean isOwner) throws FactoidCommandException {
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public LandFlag getFlagFromArg(final boolean isAdminmob, final boolean isOwner) throws FactoidCommandException {
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public PlayerContainer getPlayerContainerFromArg(final ILand land,
			final EPlayerContainerType[] bannedPCTList) throws FactoidCommandException {
		...
		if (bannedPCTList != null) {
			for (final EPlayerContainerType bPCT : bannedPCTList) {
				if (pcType == bPCT) {
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public PermissionType getPermissionTypeFromArg(final boolean isAdminmod, final boolean isOwner) throws FactoidCommandException {
	 ...
	 * @throws FactoidCommandException the factoid command exception
	 */
	public Permission getPermissionFromArg(final boolean isAdminmod, final boolean isOwner) throws FactoidCommandException {

		final PermissionType pt = getPermissionTypeFromArg(isAdminmod, isOwner);
		final String curArg = getNext();
