...
public enum FlagType {
    ...
    EXPLOSION("EXPLOSION", FlagValueType.BOOLEAN, false),
    CREEPER_EXPLOSION("CREEPER_EXPLOSION", FlagValueType.BOOLEAN, false),
    TNT_EXPLOSION("TNT_EXPLOSION", FlagValueType.BOOLEAN, false),
